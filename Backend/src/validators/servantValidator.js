...
const createServantSchema = z.object({
  body: z.object({
    ...
    bio: z.string().max(500, "Bio cannot exceed 500 characters").optional(),
    experience: optionalRateNumber().refine(val => val === undefined || val === null || val < 50, "Years of experience must be under 50 years"),
    hourlyRate: optionalRateNumber().refine(val => val === undefined || val === null || (val >= 0 && val <= 100000), "Invalid hourly rate"),
    monthlyRate: optionalRateNumber().refine(val => val === undefined || val === null || (val >= 0 && val <= 1000000), "Invalid monthly rate"),
    availableFrom: z.string().optional(),
    availableTo: z.string().optional(),
    workingDays: z.union([z.string(), z.array(z.string())]).optional(),
    offersSession: booleanString().optional(),
